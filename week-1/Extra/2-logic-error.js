...
function trimWord(word) {
  return word.trim(); //Agrego punto a trim
}

function getWordLength(word) {
  return word.length; //Quito comillas en word y agrego ";" faltante. Quito doble parentesis.
}

function multiply(a, b, c) {
  return a * b * c; //Subo return a la multiplicación
}
